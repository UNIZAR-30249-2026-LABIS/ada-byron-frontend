            ...
            <aside className="w-[260px] bg-white border-r border-gray-200 flex flex-col h-full shrink-0 shadow-sm z-10 relative">
                <div className="p-4 flex flex-col h-full">
                    ...
                    <div className="flex flex-col gap-4 flex-1">
                        ...
                        <div 
                            id="mis-reservas-nav"
                            className="mt-2 bg-slate-50 border border-gray-200 rounded-xl p-3 text-center transition-transform hover:-translate-y-0.5 cursor-pointer group shadow-sm shrink-0"
                            onClick={() => navigate('/mis-reservas')}
                        >
                            <p className="text-gray-500 text-[11px] font-medium leading-snug mb-2">
                                Consulta y gestiona tus reservas
                            </p>
                            <button className="text-gray-700 text-xs font-bold group-hover:text-gray-900 transition-colors inline-flex items-center gap-1 cursor-pointer">
                                Mis Reservas <span aria-hidden="true" className="group-hover:translate-x-1 transition-transform">&rarr;</span>
                            </button>
                        </div>
                    </div>
